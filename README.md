...
> **💡 Tip:** Customize all shortcuts via the Settings panel (⚙️ icon in toolbar)
> **📚 Full Guide:** See [Keyboard Shortcuts Documentation](docs/KEYBOARD_SHORTCUTS_GUIDE.md) for detailed customization options
...
- Extension icon and assets - See [CREDITS.md](CREDITS.md)
